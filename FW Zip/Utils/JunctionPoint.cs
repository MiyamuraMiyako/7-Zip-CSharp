...
{
    //Thanks for jeff.brown:http://www.codeproject.com/Articles/15633/Manipulating-NTFS-Junction-Points-in-NET
    //Thanks for TianFang:http://www.cnblogs.com/TianFang/archive/2009/01/31/1381551.html
    ...
    static class JunctionPoint
    {
        ...
        public static bool Create(string junctionPoint, string targetDir)
        {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
            {
                ...
                try
                {
                    ...
                    int bytesReturned;
                    return DeviceIoControl(handle.DangerousGetHandle(), FSCTL_SET_REPARSE_POINT,
